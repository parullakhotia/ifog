...
public class Controller extends SimEntity{
	...
	private void formClusters() {
		...
		for(int i=0;i<getFogDevices().size();i++){
			...
			//add nearby fog devices connected to similar parents to one cluster
		...
		// if cluster already exists, add the new members otherwise add new cluster id to cluster info and list of clusters
	...
	public double calculateDistance(FogDevice fogDevice, FogDevice anUpperDevice) {
